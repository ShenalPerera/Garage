...
public class MultiServiceScheduleCreateDTO {
...
//    @Min(value = 1, message = "Max capacity should have value greater than 0")
    ...
    public MultiServiceScheduleCreateDTO(Time startTime, Time endTime, Date date, List<Integer> serviceId, int maxCapacity, Boolean isRecurrent, Integer period) {
    ...
    public MultiServiceScheduleCreateDTO(Time startTime, Time endTime, Date date, List<Integer> serviceId, int maxCapacity) {
        this.startTime = startTime;
        this.endTime = endTime;
        this.date = date;
        this.serviceId = serviceId;
    ...
    public MultiServiceScheduleCreateDTO() {
    }
    ...
    public String toString() {
        return "MultiServiceScheduleCreateDTO{" +
                "startTime=" + startTime +
                ", endTime=" + endTime +
                ", date=" + date +
                ", serviceId=" + serviceId +
